...
!!! abstract "この章について"
    この章では、リターン図（ある天体が出生時と同じ位置に戻る瞬間の図）の使い方をまとめます。**ソーラーリターン**・**ルナーリターン** をはじめ、太陽から冥王星まで各天体のリターン図を作成でき、**一重円・二重円・三重円** の3つの表示に切り替えられます。
...
3. 左端の **リターン種類** セレクトで、**ソーラーリターン／ルナーリターン／マーキュリーリターン／ヴィーナスリターン／マーズリターン／ジュピターリターン／サターンリターン／ウラヌスリターン／ネプチューンリターン／プルートリターン** のいずれかを選びます。
4. 隣の **位相角** セレクトで、**0°（合）／90°（スクエア）／180°（オポジション）／270°（スクエア）** を選びます（既定は0°＝通常のリターン）。
...
!!! info "プラン"
    リターン図＝**Plus プラン以上**。マーキュリー〜プルートなど他天体のリターンは、設計上 **Pro プラン以上** の想定です（※要確認）。
...
2. 三重円を選んだときは、**ソーラーアーク / セカンダリー** のセレクトで進行法を選べます。
...
2. 「**クイック設定**」ボタンから、その場で表示天体・アスペクトを調整できます（**Plus プラン以上**）。
...
!!! info "プラン"
    リターン図の利用＝**Plus プラン以上**／地名検索＝**Basic 以上**／印刷・PNG保存＝**Basic 以上**／クイック設定＝**Plus 以上**。
