...
![年表を開き、ヘッダーの出生データピッカーで対象者を選ぶ](assets/timeline-01-select.jpg)
...
![イベント追加ダイアログ（年・月・カテゴリ・できごと）](assets/timeline-02-add-event.jpg)
...
![イベントを展開した詳細表示（ダイレクション・トランジットの一覧と、下部の三重円・イベント編集・削除ボタン）](assets/timeline-03-event-detail.jpg)
